...
aws ecr batch-delete-image --repository-name $ECR_REPO_NAME --region $REGION --image-ids imageTag=latest
aws ecr batch-delete-image --repository-name $ECR_REPO_NAME --region $REGION --image-ids imageTag=untagged
